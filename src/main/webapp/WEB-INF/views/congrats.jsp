...
<div class="lc-block">
    ...
    <div style="margin-left:15%">
        ...
        <div class="w3-container">
            <h2 class="text-center">Congratulations! ${pageContext.request.userPrincipal.name}</h2>
        </div>
        <div>
            <h3 class="text-center">Your application has been accepted. When you are enrolled, your last name will appear in the list of students.</h3>
        </div>
