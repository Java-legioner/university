...
<div class="lc-block">
    ...
    <div style="margin-left:15%">
        <div class="w3-container w3-teal card-text">
            <h1 class="header-lang"><spring:message code="userList.title" text="default" /></h1>
            <div class="lang">
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-8"><h2><spring:message code="userList.title" text="default" /></h2></div>
                        </div>
                    </div>
                        ...
                        <c:if test="${not empty users}">
                            <c:forEach var="user" items="${users}">
                                <tr>
                                    ...
                                    <td>${user.roles}</td>
                                    <td>
                                        <a href="/user/${user.id}"><spring:message code="edit" text="default" /></a>
